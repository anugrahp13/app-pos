                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative z-10 inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-green-500 hover:bg-green-600 border border-green-600 cursor-default leading-5 focus:outline-none focus:ring ring-green-300 focus:border-green-300 active:bg-green-600 transition ease-in-out duration-150">{{ $page }}</span>
                                    </span>
                                @else
